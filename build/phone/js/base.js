...
(function(li, $) {
    ...
    li.BaseObject.prototype = {
         ...
         * @param {boolean} instantCall [optional] if true, callback will be called immediatly
         * @return interval-id generated by setInterval() function or null
         */
        setInterval: function(id, callback, millisec, overwrite, instantCall) {
            overwrite = this.defaults(overwrite, true);
            instantCall = this.defaults(instantCall, true);
